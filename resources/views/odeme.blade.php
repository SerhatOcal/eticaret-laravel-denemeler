                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control adsoyad" name="adsoyad" id="adsoyad"  value="{{ auth()->user()->adsoyad }}" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="adres">Adres</label>
                                <input type="text" class="form-control adres" name="adres" id="adres" value="{{ $kullanici_detay->adres }}"required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control ceptelefonu" name="ceptelefonu" id="ceptelefonu" value="{{ $kullanici_detay->ceptelefonu }}" required>
                            </div>
                        </div>
                    </div>
                </div>
